...
import org.opensearch.notifications.spi.transport.SnsDestinationTransport
...
internal class SnsDestinationTests {
    ...
    fun `test sns message success response`() {
        ...
        val actualSnsResponse: DestinationMessageResponse = NotificationSpi.sendMessage(destination, message, "ref")
