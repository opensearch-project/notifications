...
class NotificationsPluginIT : OpenSearchIntegTestCase() {
    // TODO: Skipping this for now, should create an abstract class that extends OpenSearchIntegTestCase
    //   and overrides things like nodePlugins() so the node configuration is as we expect for these tests
...
//        assertTrue(
//            pluginInfos.stream()
//                .anyMatch { pluginInfo: PluginInfo -> pluginInfo.name == "wazuh-indexer-notifications" }
//        )
//    }
}
