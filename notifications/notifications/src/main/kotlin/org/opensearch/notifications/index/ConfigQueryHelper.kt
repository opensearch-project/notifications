...
object ConfigQueryHelper {
    ...
    private fun getTermQueryBuilder(
        queryKey: String,
        queryValue: String,
    ): QueryBuilder = QueryBuilders.termQuery("$KEY_PREFIX.$queryKey", queryValue)
    ...
    private fun getNestedMatchQueryBuilder(
        queryKey: String,
        queryValue: String,
    ): QueryBuilder {
