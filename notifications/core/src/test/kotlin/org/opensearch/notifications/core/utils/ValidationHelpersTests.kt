...
internal class ValidationHelpersTests {
    ...
    fun `test hosts not in denylist`() {
        ...
        for (url in urls) {
            assertEquals(
                false,
                org.opensearch.notifications.spi.utils
                    .isHostInDenylist("https://$url", hostDenyList),
    ...
    fun `test hostname gets resolved to ip for denylist`() {
        ...
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$invalidHost", hostDenyList),
        )
        ...
        assertEquals(
            false,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$validHost", hostDenyList),
        )
    }
    ...
    fun `test direct IP in denylist blocked immediately without DNS`() {
        ...
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$blockedIp", hostDenyList),
        )
    }
    ...
    fun `test direct IP in CIDR range blocked immediately`() {
        ...
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$ipInRange", hostDenyList),
        )
    }
    ...
    fun `test hostname NOT in denylist but resolves to blocked IP`() {
        ...
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$hostname", hostDenyList),
        )
    }
    ...
    fun `test direct safe IP allowed without DNS`() {
        ...
        assertEquals(
            false,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$safeIp", hostDenyList),
        )
    }
    ...
    fun `test hostname resolves to safe IP allowed`() {
        ...
        assertEquals(
            false,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$safeHostname", hostDenyList),
        )
    }
    ...
    fun `test exact IP match in denylist`() {
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://9.9.9.9", hostDenyList),
        )
    }
    ...
    fun `test CIDR range boundaries`() {
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://10.0.0.1", hostDenyList),
        )
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://10.255.255.255", hostDenyList),
        )
        assertEquals(
            false,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://11.0.0.1", hostDenyList),
        )
    }
    ...
    fun `test hostname blocked BEFORE DNS resolution when hostname is in denylist`() {
        ...
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$blockedHostname", hostDenyList),
    ...
    fun `test DNS rebinding attack prevention - hostname resolves to private IP`() {
        ...
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$attackerDomain", hostDenyList),
    ...
    fun `test DNS resolution failure handling`() {
        ...
        assertEquals(
            false,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$unresolveableHostname", hostDenyList),
    ...
    fun `test URL with port number is handled correctly`() {
        ...
        testCases.forEach { (url, shouldBeBlocked) ->
            assertEquals(
                shouldBeBlocked,
                org.opensearch.notifications.spi.utils
                    .isHostInDenylist(url, hostDenyList),
    ...
    fun `test exact IP 9-9-9-9 in denylist is blocked`() {
        ...
        assertEquals(
            false,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://9.9.9.8", hostDenyList),
        ...
        assertEquals(
            false,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://9.9.9.10", hostDenyList),
    ...
    fun `test IPv6 loopback is blocked when in denylist`() {
        ...
        assertEquals(
            true,
            org.opensearch.notifications.spi.utils
                .isHostInDenylist("https://$hostname", denyListWithIpv6Loopback),
